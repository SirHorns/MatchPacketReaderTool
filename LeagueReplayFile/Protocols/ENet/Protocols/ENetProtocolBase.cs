namespace LeagueReplayFile.Protocols.ENet.Protocols
{
    public abstract class ENetProtocolBase
    {
        ...
        public static readonly Dictionary<ENetProtocolCommand, Func<ENetProtocolHeader, ENetProtocolCommandHeader, BinaryReader, ENetProtocolBase>> CommandConstructors;

        static ENetProtocolBase()
        {
            CommandFullSize = new Dictionary<ENetProtocolCommand, int>
            {
            ...
            CommandConstructors  = new Dictionary<ENetProtocolCommand, Func<ENetProtocolHeader, ENetProtocolCommandHeader, BinaryReader, ENetProtocolBase>>
            {
